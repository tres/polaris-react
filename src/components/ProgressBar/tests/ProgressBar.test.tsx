...
describe('<ProgressBar />', () => {
  ...
  describe('animated prop', () => {
    it('sets the progress bar to include the animation class by default', () => {
    ...
    it('sets the progress bar to exclude the animation class by when animated prop is false', () => {
